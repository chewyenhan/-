...
- **AI Engine**: Google Gemini API（通过 Cloudflare Worker 代理，Key 已内置）
- **Deployment**: GitHub Pages 静态部署

## 🚀 快速开始
学生打开 👉 **[https://chewyenhan.github.io/-/](https://chewyenhan.github.io/-/)** 即玩，无需下载，无需输入 API Key。AI 对话功能自动可用。
